...
{
    /// <summary>
    /// UML: Core.User.Facade page — UserCreateJobs «named» : UserCreateBase
    /// </summary>
    public class UserCreateJobs : UserCreateBase
    {
        public UserCreateJobs( IXInvoker pInvoker ) : base( pInvoker )
        {
        }
